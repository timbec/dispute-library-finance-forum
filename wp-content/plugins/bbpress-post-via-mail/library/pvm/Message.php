...
class pvm_Message {
	 ...
	 *      * @param pvm_Message $message Message being sent
	 *      * @return string Reply email address
	 *      * /
	 *     function my_handler( WP_User $user, pvm_Message $message );
	 *
	 * @param callable $handler Handler function (passed WP_User instance and pvm_Message handler)
	 */
